    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            ...
            try {
                ...
                const companiesWithJobCounts = companiesData.companies.map(company => {
                    const jobCount = jobsData.jobs.filter(job => 
                ...
                <div className="search-section">
                    ...
                    {searchTerm && (
                        <div className="search-results-info">
                            <p>Found {filteredCompanies.length} company{filteredCompanies.length !== 1 ? 'ies' : ''} matching "{searchTerm}"</p>
                        </div>
                    )}
                </div>
