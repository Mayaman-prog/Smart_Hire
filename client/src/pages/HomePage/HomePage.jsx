...
const HomePage = () => {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            try {
                const featured = jobsData.jobs.filter(job => job.is_featured === true);
    ...
    return (
        <div className="home-page">
                ...
                <div className="container">
                    <div className="hero-content">
                        ...
                        <div className="hero-buttons">
                            <button onClick={handleSearchJobs} className="btn-primary btn-large">
                                <span className="material-symbols-outlined">search</span>
                                Search Jobs
                            </button>
                            <button onClick={handlePostJob} className="btn-secondary btn-large">
            ...
            {/* Featured Jobs Section - Full Width Background */}
                ...
                <div className="container">
                    ...
                    {loading ? (
                        ...
                        <div className="empty-state">
                            ...
                            <p className="empty-text">Check back later for new opportunities</p>
                        </div>
                    )}
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="steps-grid">
                        ...
                        <div className="step-card">
                            ...
                            <p className="step-description">
                                Get hired by top companies or find the perfect candidate for your role
                            </p>
                        </div>
                    </div>
                </div>
